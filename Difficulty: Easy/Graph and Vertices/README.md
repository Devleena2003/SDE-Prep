<h2><a href="https://www.geeksforgeeks.org/problems/graph-and-vertices/1?page=11&difficulty=Easy&status=unsolved&sortBy=submissions">Graph and Vertices</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer <strong>n</strong> representing number of vertices. Find out how many <strong>undirected graphs </strong>(not necessarily connected) can be constructed out of a given n number of vertices.</span></p>
