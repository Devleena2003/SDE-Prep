<h2><a href="https://www.geeksforgeeks.org/problems/allocate-minimum-number-of-pages0937/1?page=1&category=Arrays,Mathematical,Strings,Sorting,Hash,Bit%20Magic,Matrix,Greedy,Recursion,Searching,Binary%20Search,two-pointer-algorithm,sliding-window,Map,Heap,Backtracking,prefix-sum,Pointers,Kadane&status=unsolved&sortBy=submissions">Allocate Minimum Pages</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">You are given an array <code>arr[]</code> of integers, where each element <code>arr[i]</code> represents the number of pages in the ith book. You also have an integer <code>k</code> representing the number of students. The task is to allocate books to each student such that:</span></p>
<ul>
